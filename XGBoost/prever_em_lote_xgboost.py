...
alunos_para_prever = pd.read_csv('alunos_para_prever.csv', encoding='latin1', sep=';')  # Arquivo de alunos
...
alunos_para_prever.to_csv('resultados_previsoes_xgboost.csv', index=False, encoding='latin1', sep=';')
